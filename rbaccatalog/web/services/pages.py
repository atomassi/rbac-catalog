...
from rbaccatalog.core.constants import DEFAULT_ROLE_TYPE
from rbaccatalog.core.diffing import RoleDiff
from rbaccatalog.core.enums import SortOrder
from rbaccatalog.core.utils import truncate_microseconds
from rbaccatalog.web.services.models import (
    EnrichedChangeEvent,
...
from rbaccatalog.web.utils import role_json_pretty
...
async def get_role_from_cache_or_db(
    ...
    *,
    ...
    from rbaccatalog.telemetry import DbFallbackType, DbQueryName, TimedDbQuery
    ...
    async with session_local() as session:
        async with TimedDbQuery(
            DbQueryName.FETCH_ROLE_BY_ID, fallback_type=DbFallbackType.ROLE_DETAIL
        ) as timer:
        ...
        from rbaccatalog.core import RoleScanStatus

        async with TimedDbQuery(
            DbQueryName.FETCH_FIRST_SCAN_TIMESTAMP, fallback_type=DbFallbackType.ROLE_DETAIL
        ):
        ...
        async with TimedDbQuery(
            DbQueryName.FETCH_ROLE_HISTORY, fallback_type=DbFallbackType.ROLE_DETAIL
        ) as timer:
...
def build_role_redirect_url(
    ...
    from rbaccatalog.web.constants import DEFAULT_DAYS, DEFAULT_LIMIT, DEFAULT_PAGE
