...
from rbaccatalog.core.patterns import WILDCARD, is_wildcard_pattern, matches_pattern
from rbaccatalog.core.utils import truncate_microseconds
from rbaccatalog.matching.models import (
    Plane,
    RoleCoverage,
)
from rbaccatalog.matching.role_matching import is_high_privilege_role
...
async def build_from_db(session: AsyncSession) -> CacheData:
    ...
    from rbaccatalog.telemetry import DbQueryName, TimedDbQuery
