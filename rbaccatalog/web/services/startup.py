...
async def preload_cache(session_factory: async_sessionmaker[_AsyncSession]) -> None:
    ...
    from rbaccatalog.telemetry import track_startup
...
async def cache_refresh_task(session_factory: async_sessionmaker[_AsyncSession]) -> None:
    ...
    from rbaccatalog.telemetry import track_cache_refresh, track_cache_refresh_failure
...
async def ensure_db(engine: AsyncEngine) -> None:
    ...
    from rbaccatalog.core import ensure_db as ensure_db_core
...
async def warmup_crossencoder() -> None:
    ...
    from rbaccatalog.airecommender.engines.crossencoder import get_cross_encoder
