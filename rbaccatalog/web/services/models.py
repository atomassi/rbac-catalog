...
from rbaccatalog.core.enums import EventType, SortOrder
from rbaccatalog.core.patterns import (
...
if TYPE_CHECKING:
    from rbaccatalog.azure.models import OperationData, Permission, RoleDefinition
