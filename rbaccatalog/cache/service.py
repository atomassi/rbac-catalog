...
from rbaccatalog.core.constants import DEFAULT_SEARCH_LIMIT
...
from rbaccatalog.matching.models import RoleCoverage, RoleNetPermissions
from rbaccatalog.telemetry import CacheType, track_cache_call, track_cache_hit

if TYPE_CHECKING:
    from sqlalchemy.ext.asyncio import AsyncSession

    from rbaccatalog.azure.models import OperationData, RoleDefinition
    from rbaccatalog.comparer import RoleComparison
    from rbaccatalog.web.routes.models import OperationWithCount
...
class CacheService:
    ...
    async def rebuild_in_memory(self, session: AsyncSession) -> bool:
        ...
        async with _REBUILD_LOCK:
            try:
                from rbaccatalog.cache.build import build_from_db
    ...
    def _initialize_ai_recommender(self, cache_data: CacheData) -> None:
        ...
        try:
            from rbaccatalog.airecommender import get_ai_recommender
    ...
    def _seed_popular_comparisons(self, cache_data: CacheData) -> RequestCaches:
        ...
        """
        from rbaccatalog.comparer import build_comparison
    ...
    def count_wildcard_matches(self, pattern: str, is_data_action: bool = False) -> int:
        ...
        from rbaccatalog.core.patterns import pattern_to_regex
